...
import { createStoryTemplate, startStory, getStories, deleteStory, chatWithStory, updateStoryTemplateById, getMyStories, getStory } from '../modules/stories/infrastructure/http/StoryHttpAdapter.js';
